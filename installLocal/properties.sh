...
export baseMadridG=$scriptHome/basedata/MADRID.geojson
export baseBarriosG=$scriptHome/basedata/Barrios.geojson
export ouPathAgg=$scriptHome/data/transporte_agregado.csv
